...
class BinaryStore
{
	...
	public:
		...
		//ADD function will take two strings as input parameters and given the binary equivalent in form of string.
		// comp_EQUAL, comp_AND, and comp_OR function will take two strings as input parameters and given the binary equivalent in form of string.
